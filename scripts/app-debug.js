...
var _user$project$Grid$slugify = function (s) {
	return A4(
...
var _user$project$Grid$stylesToCSS = F2(
	function (selector, styles) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Basics_ops['++'], selector, ' {'),
				_1: {
					ctor: '::',
...
var _user$project$Grid$listCombine = F3(
	function (fn, a, b) {
		return A2(
			_elm_lang$core$List$concatMap,
			function (a_) {
...
var _user$project$Grid$listUpdateWhere = F3(
	function (predicate, replace, list) {
		var accum = F2(
			function (a, newlist) {
				return predicate(a) ? {ctor: '::', _0: replace, _1: newlist} : {ctor: '::', _0: a, _1: newlist};
			});
		return A3(
			_elm_lang$core$List$foldr,
			accum,
...
var _user$project$Grid$listRemoveWhere = F2(
	function (predicate, list) {
		var accum = F2(
			function (a, newlist) {
				return predicate(a) ? newlist : {ctor: '::', _0: a, _1: newlist};
			});
		return A3(
			_elm_lang$core$List$foldr,
			accum,
...
var _user$project$Grid$listFind = F2(
	function (predicate, list) {
		listFind:
		while (true) {
			var _p2 = list;
...
var _user$project$Grid$listSetAt = F3(
	function (index, a, list) {
		if (_elm_lang$core$Native_Utils.cmp(index, 0) < 0) {
			...
			var _p4 = {
				ctor: '_Tuple2',
				_0: A2(_elm_lang$core$List$take, index, list),
				_1: _elm_lang$core$List$tail(
...
var _user$project$Grid$listGetAt = F2(
	function (index, list) {
		return (_elm_lang$core$Native_Utils.cmp(index, 0) < 0) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$List$head(
			A2(_elm_lang$core$List$drop, index, list));
	});
var _user$project$Grid$placeholderToStyles = function (_p5) {
	var _p6 = _p5;
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 'grid-row',
			_1: _elm_lang$core$Basics$toString(_p6._0.row + 1)
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'grid-column',
				_1: _elm_lang$core$Basics$toString(_p6._0.col + 1)
			},
			_1: {ctor: '[]'}
		}
	};
};
var _user$project$Grid$sectionToStyles = function (_p7) {
	var _p8 = _p7;
	var stringDim = F2(
		function (n, sz) {
			return _elm_lang$core$Native_Utils.eq(sz, 1) ? _elm_lang$core$Basics$toString(n + 1) : A2(
				_elm_lang$core$Basics_ops['++'],
	...
	return {
		...
		_0: {
			ctor: '_Tuple2',
			_0: 'grid-row',
			_1: A2(stringDim, _p8._0.row, _p8._0.rowSpan)
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'grid-column',
				_1: A2(stringDim, _p8._0.col, _p8._0.colSpan)
			},
			_1: {ctor: '[]'}
		}
	};
};
var _user$project$Grid$sectionElementToStyles = function (section) {
	var _p9 = section;
	if (_p9.ctor === 'PlaceholderElement') {
		return _user$project$Grid$placeholderToStyles(_p9._0);
	} else {
		return _user$project$Grid$sectionToStyles(_p9._0);
	}
};
var _user$project$Grid$sectionElementToCSS = F2(
	function (selector, section) {
		return A2(
			_user$project$Grid$stylesToCSS,
			selector,
			_user$project$Grid$sectionElementToStyles(section));
	});
var _user$project$Grid$placeholderInCol = F2(
	function (c, _p10) {
		var _p11 = _p10;
		return _elm_lang$core$Native_Utils.eq(c, _p11._0.col);
	});
var _user$project$Grid$placeholderInRow = F2(
	function (r, _p12) {
		var _p13 = _p12;
		return _elm_lang$core$Native_Utils.eq(r, _p13._0.row);
	});
var _user$project$Grid$placeholderRowCol = function (_p14) {
	var _p15 = _p14;
	return {ctor: '_Tuple2', _0: _p15._0.row, _1: _p15._0.col};
};
var _user$project$Grid$placeholderRow = function (_p16) {
	return _elm_lang$core$Tuple$first(
		_user$project$Grid$placeholderRowCol(_p16));
};
var _user$project$Grid$placeholderCol = function (_p17) {
	return _elm_lang$core$Tuple$second(
		_user$project$Grid$placeholderRowCol(_p17));
};
var _user$project$Grid$sectionContentName = function (_p18) {
	var _p19 = _p18;
	return _p19._0.name;
};
var _user$project$Grid$rectInside = F2(
	function (a, b) {
		return ((_elm_lang$core$Native_Utils.cmp(a.left, b.left) > -1) && (_elm_lang$core$Native_Utils.cmp(a.right, b.right) < 1)) && ((_elm_lang$core$Native_Utils.cmp(a.top, b.top) > -1) && (_elm_lang$core$Native_Utils.cmp(a.bottom, b.bottom) < 1));
	});
var _user$project$Grid$rectIntersects = F2(
	function (a, b) {
		return ((_elm_lang$core$Native_Utils.cmp(a.right, b.left) > -1) && (_elm_lang$core$Native_Utils.cmp(a.left, b.right) < 1)) && ((_elm_lang$core$Native_Utils.cmp(a.bottom, b.top) > -1) && (_elm_lang$core$Native_Utils.cmp(a.top, b.bottom) < 1));
	});
var _user$project$Grid$rectIntersection = F2(
	function (a, b) {
		var max = F2(
			function (x, y) {
				return (_elm_lang$core$Native_Utils.cmp(x, y) > 0) ? x : y;
			});
		var min = F2(
			function (x, y) {
				return (_elm_lang$core$Native_Utils.cmp(x, y) < 0) ? x : y;
			});
		return A2(_user$project$Grid$rectIntersects, a, b) ? _elm_lang$core$Maybe$Just(
			{
				top: A2(max, a.top, b.top),
				left: A2(max, a.left, b.left),
				bottom: A2(min, a.bottom, b.bottom),
				right: A2(min, a.right, b.right)
			}) : _elm_lang$core$Maybe$Nothing;
	});
var _user$project$Grid$gridRect = function (_p20) {
	var _p21 = _p20;
	return {
		top: 0,
		left: 0,
		bottom: _elm_lang$core$List$length(_p21._0.rows) - 1,
		right: _elm_lang$core$List$length(_p21._0.cols) - 1
	};
};
var _user$project$Grid$sectionRect = function (_p22) {
	var _p23 = _p22;
	var _p25 = _p23._0.row;
	var _p24 = _p23._0.col;
	return {top: _p25, left: _p24, bottom: (_p25 + _p23._0.rowSpan) - 1, right: (_p24 + _p23._0.colSpan) - 1};
};
var _user$project$Grid$sectionIntersects = F2(
	function (a, b) {
		return A2(
			_user$project$Grid$rectIntersects,
			_user$project$Grid$sectionRect(a),
			_user$project$Grid$sectionRect(b));
	});
var _user$project$Grid$sectionInsideGrid = F2(
	function (section, grid) {
		return A2(
			_user$project$Grid$rectInside,
			_user$project$Grid$sectionRect(section),
			_user$project$Grid$gridRect(grid));
	});
var _user$project$Grid$gridCoords = function (_p26) {
	var _p27 = _p26;
	return A3(
		_user$project$Grid$listCombine,
		F2(
			function (v0, v1) {
				return {ctor: '_Tuple2', _0: v0, _1: v1};
			}),
		A2(
			_elm_lang$core$List$range,
			0,
			_elm_lang$core$List$length(_p27._0.rows) - 1),
		A2(
			_elm_lang$core$List$range,
			0,
			_elm_lang$core$List$length(_p27._0.cols) - 1));
};
var _user$project$Grid$sectionRemoveFrom = F2(
	function (_p28, sections) {
		var _p29 = _p28;
		return A2(
			_user$project$Grid$listRemoveWhere,
			function (_p30) {
				var _p31 = _p30;
				var _p32 = _p31._0;
				return _elm_lang$core$Native_Utils.eq(_p32.row, _p29._0.row) && _elm_lang$core$Native_Utils.eq(_p32.col, _p29._0.col);
			},
			sections);
	});
var _user$project$Grid$sectionCanBePlacedIn = F3(
	function (grid, section, sections) {
		return A2(
			_elm_lang$core$List$all,
			function (_p33) {
				return !A2(_user$project$Grid$sectionIntersects, section, _p33);
			},
			sections) && A2(_user$project$Grid$sectionInsideGrid, section, grid);
	});
var _user$project$Grid$sectionPlaceIn = F3(
	function (grid, section, sections) {
		return A3(_user$project$Grid$sectionCanBePlacedIn, grid, section, sections) ? {ctor: '::', _0: section, _1: sections} : sections;
	});
var _user$project$Grid$sectionName = function (_p34) {
	var _p35 = _p34;
	return _user$project$Grid$sectionContentName(_p35._0.content);
};
var _user$project$Grid$sectionInCol = F2(
	function (c, _p36) {
		var _p37 = _p36;
		var _p38 = _p37._0.col;
		return (_elm_lang$core$Native_Utils.cmp(c, _p38) > -1) && (_elm_lang$core$Native_Utils.cmp(c, _p38 + _p37._0.colSpan) < 0);
	});
var _user$project$Grid$sectionInRow = F2(
	function (r, _p39) {
		var _p40 = _p39;
		var _p41 = _p40._0.row;
		return (_elm_lang$core$Native_Utils.cmp(r, _p41) > -1) && (_elm_lang$core$Native_Utils.cmp(r, _p41 + _p40._0.rowSpan) < 0);
	});
var _user$project$Grid$standardUnitToString = function (unit) {
	var _p42 = unit;
	if (_p42.ctor === 'Px') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
...
var _user$project$Grid$gridUnitToString = function (unit) {
	var _p43 = unit;
	switch (_p43.ctor) {
		case 'StdUnit':
			return _user$project$Grid$standardUnitToString(_p43._0);
		case 'Fr':
			return A2(
				_elm_lang$core$Basics_ops['++'],
...
var _user$project$Grid$standardUnitRange = function (unit) {
	var _p44 = unit;
	if (_p44.ctor === 'Px') {
		return _elm_lang$core$Maybe$Just(
...
var _user$project$Grid$gridUnitRange = function (unit) {
	var _p45 = unit;
	switch (_p45.ctor) {
		case 'StdUnit':
			return _user$project$Grid$standardUnitRange(_p45._0);
		case 'Fr':
			return _elm_lang$core$Maybe$Just(
				{min: 1, max: 16, step: 1});
		default:
...
var _user$project$Grid$standardUnitValue = function (unit) {
	var _p46 = unit;
	if (_p46.ctor === 'Px') {
...
var _user$project$Grid$gridUnitValue = function (unit) {
	var _p47 = unit;
	switch (_p47.ctor) {
		case 'StdUnit':
			return _user$project$Grid$standardUnitValue(_p47._0);
		case 'Fr':
...
var _user$project$Grid$standardUnitIsRem = function (unit) {
	var _p48 = unit;
	if (_p48.ctor === 'Rem') {
		return true;
	} else {
...
var _user$project$Grid$standardUnitIsPx = function (unit) {
	var _p49 = unit;
	if (_p49.ctor === 'Px') {
		return true;
	} else {
...
var _user$project$Grid$gridUnitIsMinContent = function (unit) {
	var _p50 = unit;
	if (_p50.ctor === 'MinContent') {
		return true;
	} else {
		return false;
	}
};
var _user$project$Grid$gridUnitIsFr = function (unit) {
	var _p51 = unit;
	if (_p51.ctor === 'Fr') {
		return true;
	} else {
...
var _user$project$Grid$gridUnitIsRem = function (unit) {
	var _p52 = unit;
	if (_p52.ctor === 'StdUnit') {
		return _user$project$Grid$standardUnitIsRem(_p52._0);
	} else {
		return false;
	}
};
var _user$project$Grid$gridUnitIsPx = function (unit) {
	var _p53 = unit;
	if (_p53.ctor === 'StdUnit') {
		return _user$project$Grid$standardUnitIsPx(_p53._0);
	} else {
		return false;
	}
};
var _user$project$Grid$gridUnitsToString = function (units) {
	var _p54 = units;
	if (_p54.ctor === '[]') {
		return _elm_lang$core$Maybe$Nothing;
	} else {
		return _elm_lang$core$Maybe$Just(
			A2(
				_elm_lang$core$String$join,
				' ',
				A2(_elm_lang$core$List$map, _user$project$Grid$gridUnitToString, units)));
	}
};
var _user$project$Grid$gridToStyles = function (_p55) {
	var _p56 = _p55;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		{
			...
			_1: {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'grid-row-gap',
					_1: _user$project$Grid$standardUnitToString(_p56._0.rowGap)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'grid-column-gap',
						_1: _user$project$Grid$standardUnitToString(_p56._0.colGap)
					},
					_1: {ctor: '[]'}
				}
			}
			...
			A2(
				...
				A2(
					...
					function (rs) {
						return {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'grid-template-rows', _1: rs},
							_1: {ctor: '[]'}
						};
					},
					_user$project$Grid$gridUnitsToString(
						_elm_lang$core$List$reverse(_p56._0.rows)))),
			A2(
				_elm_lang$core$Maybe$withDefault,
				{ctor: '[]'},
				A2(
					...
					function (cs) {
						return {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 'grid-template-columns', _1: cs},
							_1: {ctor: '[]'}
						};
					},
					_user$project$Grid$gridUnitsToString(
						_elm_lang$core$List$reverse(_p56._0.cols))))));
};
var _user$project$Grid$gridToCSS = F2(
	function (selector, grid) {
		return A2(
			_user$project$Grid$stylesToCSS,
			selector,
			_user$project$Grid$gridToStyles(grid));
	});
var _user$project$Grid$gridColUnit = F2(
	function (index, _p57) {
		var _p58 = _p57;
		var _p59 = _p58._0.cols;
		return A2(
			_user$project$Grid$listGetAt,
			(_elm_lang$core$List$length(_p59) - index) - 1,
			_p59);
	});
var _user$project$Grid$gridRowUnit = F2(
	function (index, _p60) {
		var _p61 = _p60;
		var _p62 = _p61._0.rows;
		return A2(
			_user$project$Grid$listGetAt,
			(_elm_lang$core$List$length(_p62) - index) - 1,
			_p62);
	});
var _user$project$Grid$gridSectionStyles = _user$project$Grid$sectionElementToStyles;
var _user$project$Grid$gridStyles = function (_p63) {
	var _p64 = _p63;
	return _user$project$Grid$gridToStyles(_p64._0.grid);
};
var _user$project$Grid$colUnit = F2(
	function (index, _p65) {
		var _p66 = _p65;
		return A2(_user$project$Grid$gridColUnit, index, _p66._0.grid);
	});
var _user$project$Grid$rowUnit = F2(
	function (index, _p67) {
		var _p68 = _p67;
		return A2(_user$project$Grid$gridRowUnit, index, _p68._0.grid);
	});
var _user$project$Grid$Rect = F4(
	function (a, b, c, d) {
		return {top: a, left: b, bottom: c, right: d};
	});
var _user$project$Grid$Model = function (a) {
	return {ctor: 'Model', _0: a};
};
var _user$project$Grid$mapGrid = F2(
	function (fn, _p69) {
		var _p70 = _p69;
		var _p71 = _p70._0;
		return _user$project$Grid$Model(
			_elm_lang$core$Native_Utils.update(
				_p71,
				{
					grid: fn(_p71.grid)
...
var _user$project$Grid$removeSection = F2(
	function (section, _p72) {
		var _p73 = _p72;
		var _p74 = _p73._0;
		return _user$project$Grid$Model(
			_elm_lang$core$Native_Utils.update(
				_p74,
				{
					sections: A2(_user$project$Grid$sectionRemoveFrom, section, _p74.sections)
				}));
	});
var _user$project$Grid$placeSection = F2(
	function (section, _p75) {
		var _p76 = _p75;
		var _p77 = _p76._0;
		return _user$project$Grid$Model(
			_elm_lang$core$Native_Utils.update(
				_p77,
				{
					sections: A3(_user$project$Grid$sectionPlaceIn, _p77.grid, section, _p77.sections)
				}));
	});
var _user$project$Grid$Grid = function (a) {
	return {ctor: 'Grid', _0: a};
};
var _user$project$Grid$setRowGap = F2(
	function (unit, _p78) {
		var _p79 = _p78;
...
var _user$project$Grid$setColGap = F2(
	function (unit, _p80) {
		var _p81 = _p80;
		return _user$project$Grid$Grid(
			_elm_lang$core$Native_Utils.update(
...
var _user$project$Grid$setGap = F2(
	function (unit, _p82) {
		var _p83 = _p82;
		return _user$project$Grid$Grid(
			_elm_lang$core$Native_Utils.update(
				_p83._0,
				{rowGap: unit, colGap: unit}));
	});
var _user$project$Grid$addGridRow = F2(
	function (unit, _p84) {
		var _p85 = _p84;
		var _p86 = _p85._0;
		return _user$project$Grid$Grid(
			_elm_lang$core$Native_Utils.update(
				_p86,
				{
					rows: {ctor: '::', _0: unit, _1: _p86.rows}
				}));
	});
var _user$project$Grid$addGridCol = F2(
	function (unit, _p87) {
		var _p88 = _p87;
		var _p89 = _p88._0;
		return _user$project$Grid$Grid(
			_elm_lang$core$Native_Utils.update(
				_p89,
				{
					cols: {ctor: '::', _0: unit, _1: _p89.cols}
				}));
	});
var _user$project$Grid$addRow = F3(
	function (unit, colunit, _p90) {
		var _p91 = _p90;
		var _p95 = _p91._0;
		var preAddCol = function (_p92) {
			var _p93 = _p92;
			var _p94 = _p93._0;
			return _elm_lang$core$List$isEmpty(_p94.cols) ? A2(
				_user$project$Grid$addGridCol,
				colunit,
				_user$project$Grid$Grid(_p94)) : _user$project$Grid$Grid(_p94);
		};
		return _user$project$Grid$Model(
			_elm_lang$core$Native_Utils.update(
				_p95,
				{
					grid: A2(
						_user$project$Grid$addGridRow,
						unit,
						preAddCol(_p95.grid))
				}));
	});
var _user$project$Grid$addCol = F3(
	function (unit, rowunit, _p96) {
		var _p97 = _p96;
		var _p101 = _p97._0;
		var preAddRow = function (_p98) {
			var _p99 = _p98;
			var _p100 = _p99._0;
			return _elm_lang$core$List$isEmpty(_p100.rows) ? A2(
				_user$project$Grid$addGridRow,
				rowunit,
				_user$project$Grid$Grid(_p100)) : _user$project$Grid$Grid(_p100);
		};
		return _user$project$Grid$Model(
			_elm_lang$core$Native_Utils.update(
				_p101,
				{
					grid: A2(
						_user$project$Grid$addGridCol,
						unit,
						preAddRow(_p101.grid))
				}));
	});
var _user$project$Grid$removeGridRow = function (_p102) {
	var _p103 = _p102;
	var _p104 = _p103._0;
	return _user$project$Grid$Grid(
		_elm_lang$core$Native_Utils.update(
			_p104,
			{
				rows: A2(
					_elm_lang$core$Maybe$withDefault,
					{ctor: '[]'},
					_elm_lang$core$List$tail(_p104.rows))
			}));
};
var _user$project$Grid$removeRow = function (_p105) {
	var _p106 = _p105;
	var _p107 = _p106._0;
	return _user$project$Grid$Model(
		_elm_lang$core$Native_Utils.update(
			_p107,
			{
				grid: _user$project$Grid$removeGridRow(_p107.grid)
			}));
};
var _user$project$Grid$removeGridCol = function (_p108) {
	var _p109 = _p108;
	var _p110 = _p109._0;
	return _user$project$Grid$Grid(
		_elm_lang$core$Native_Utils.update(
			_p110,
			{
				cols: A2(
					_elm_lang$core$Maybe$withDefault,
					{ctor: '[]'},
					_elm_lang$core$List$tail(_p110.cols))
			}));
};
var _user$project$Grid$removeCol = function (_p111) {
	var _p112 = _p111;
	var _p113 = _p112._0;
	return _user$project$Grid$Model(
		_elm_lang$core$Native_Utils.update(
			_p113,
			{
				grid: _user$project$Grid$removeGridCol(_p113.grid)
			}));
};
var _user$project$Grid$removeFirstGridRow = function (_p114) {
	var _p115 = _p114;
	var _p116 = _p115._0;
	return _user$project$Grid$Grid(
		_elm_lang$core$Native_Utils.update(
			_p116,
			{
				rows: A2(
					...
					_elm_lang$core$List$length(_p116.rows) - 1,
					_p116.rows)
			}));
};
var _user$project$Grid$removeFirstGridCol = function (_p117) {
	var _p118 = _p117;
	var _p119 = _p118._0;
	return _user$project$Grid$Grid(
		_elm_lang$core$Native_Utils.update(
			_p119,
			{
				cols: A2(
					_elm_lang$core$List$take,
					_elm_lang$core$List$length(_p119.cols) - 1,
					_p119.cols)
			}));
};
var _user$project$Grid$setRowUnit = F3(
	function (index, unit, _p120) {
		var _p121 = _p120;
		var _p122 = _p121._0;
		var index_ = (_elm_lang$core$List$length(_p122.rows) - index) - 1;
		return _user$project$Grid$Grid(
			_elm_lang$core$Native_Utils.update(
				_p122,
				{
					rows: A2(
						_elm_lang$core$Maybe$withDefault,
						_p122.rows,
						A3(_user$project$Grid$listSetAt, index_, unit, _p122.rows))
				}));
	});
var _user$project$Grid$setRowHeight = F3(
	function (index, unit, model) {
		return A2(
			_user$project$Grid$mapGrid,
			A2(_user$project$Grid$setRowUnit, index, unit),
			model);
	});
var _user$project$Grid$setColUnit = F3(
	function (index, unit, _p123) {
		var _p124 = _p123;
		var _p125 = _p124._0;
		var index_ = (_elm_lang$core$List$length(_p125.cols) - index) - 1;
		return _user$project$Grid$Grid(
			_elm_lang$core$Native_Utils.update(
				_p125,
				{
					cols: A2(
						_elm_lang$core$Maybe$withDefault,
						_p125.cols,
						A3(_user$project$Grid$listSetAt, index_, unit, _p125.cols))
				}));
	});
var _user$project$Grid$setColWidth = F3(
	function (index, unit, model) {
		return A2(
			_user$project$Grid$mapGrid,
			A2(_user$project$Grid$setColUnit, index, unit),
			model);
	});
var _user$project$Grid$Section = function (a) {
	return {ctor: 'Section', _0: a};
};
var _user$project$Grid$sectionUpdateIn = F2(
	function (_p126, sections) {
		var _p127 = _p126;
		var _p131 = _p127._0;
		return A3(
			_user$project$Grid$listUpdateWhere,
			function (_p128) {
				var _p129 = _p128;
				var _p130 = _p129._0;
				return _elm_lang$core$Native_Utils.eq(_p130.row, _p131.row) && _elm_lang$core$Native_Utils.eq(_p130.col, _p131.col);
			},
			_user$project$Grid$Section(_p131),
			sections);
	});
var _user$project$Grid$updateSection = F2(
	function (section, _p132) {
		var _p133 = _p132;
		var _p134 = _p133._0;
		return _user$project$Grid$Model(
			_elm_lang$core$Native_Utils.update(
				_p134,
				{
					sections: A2(_user$project$Grid$sectionUpdateIn, section, _p134.sections)
				}));
	});
var _user$project$Grid$sectionExpand = F3(
	function (direction, grid, _p135) {
		var _p136 = _p135;
		var _p138 = _p136._0;
		var newSection = function () {
			...
			switch (_p137.ctor) {
				case 'Rightward':
					return _user$project$Grid$Section(
						_elm_lang$core$Native_Utils.update(
							_p138,
							{colSpan: _p138.colSpan + 1}));
				case 'Downward':
					return _user$project$Grid$Section(
						_elm_lang$core$Native_Utils.update(
							_p138,
							{rowSpan: _p138.rowSpan + 1}));
				case 'Leftward':
					return _user$project$Grid$Section(
						_elm_lang$core$Native_Utils.update(
							_p138,
							{col: _p138.col - 1, colSpan: _p138.colSpan + 1}));
				default:
					return _user$project$Grid$Section(
						_elm_lang$core$Native_Utils.update(
							_p138,
							{row: _p138.row - 1, rowSpan: _p138.rowSpan + 1}));
			}
		}();
		return A2(
			_user$project$Grid$rectInside,
			_user$project$Grid$sectionRect(newSection),
			_user$project$Grid$gridRect(grid)) ? _elm_lang$core$Maybe$Just(newSection) : _elm_lang$core$Maybe$Nothing;
	});
var _user$project$Grid$expandSection = F3(
	function (direction, section, _p139) {
		var _p140 = _p139;
		var _p141 = _p140._0;
		var model_ = A2(
			_user$project$Grid$removeSection,
			section,
			_user$project$Grid$Model(_p141));
		return A2(
			_elm_lang$core$Maybe$withDefault,
			model_,
			A2(
				_elm_lang$core$Maybe$map,
				function (s) {
					return A2(_user$project$Grid$placeSection, s, model_);
				},
				A3(_user$project$Grid$sectionExpand, direction, _p141.grid, section)));
	});
var _user$project$Grid$sectionShift = F3(
	function (direction, grid, _p142) {
		var _p143 = _p142;
		var _p145 = _p143._0;
		var newSection = function () {
			var _p144 = direction;
...
var _user$project$Grid$SectionContent = function (a) {
	return {ctor: 'SectionContent', _0: a};
};
var _user$project$Grid$emptySectionContent = _user$project$Grid$SectionContent(
	{name: _elm_lang$core$Maybe$Nothing});
var _user$project$Grid$rectSection = function (_p146) {
	var _p147 = _p146;
	var _p149 = _p147.top;
	var _p148 = _p147.left;
	return _user$project$Grid$Section(
		{row: _p149, col: _p148, rowSpan: (_p147.bottom - _p149) + 1, colSpan: (_p147.right - _p148) + 1, content: _user$project$Grid$emptySectionContent});
};
var _user$project$Grid$sectionAt = function (_p150) {
	var _p151 = _p150;
	var _p153 = _p151._0;
	var _p152 = _p151._1;
	return _user$project$Grid$rectSection(
		{top: _p153, left: _p152, bottom: _p153, right: _p152});
};
var _user$project$Grid$addSection = F2(
	function (_p154, model) {
		var _p155 = _p154;
		return A2(
			_user$project$Grid$placeSection,
			_user$project$Grid$sectionAt(
				{ctor: '_Tuple2', _0: _p155._0.row, _1: _p155._0.col}),
			model);
	});
var _user$project$Grid$sectionIntersection = F2(
	function (a, b) {
		return A2(
			_elm_lang$core$Maybe$map,
			_user$project$Grid$rectSection,
			A2(
				_user$project$Grid$rectIntersection,
				_user$project$Grid$sectionRect(a),
				_user$project$Grid$sectionRect(b)));
	});
var _user$project$Grid$sectionContentSetName = F2(
	function (name, _p156) {
		var _p157 = _p156;
		return _user$project$Grid$SectionContent(
			_elm_lang$core$Native_Utils.update(
				_p157._0,
				{
...
var _user$project$Grid$sectionSetName = F2(
	function (name, _p158) {
		var _p159 = _p158;
		var _p160 = _p159._0;
		return _user$project$Grid$Section(
			_elm_lang$core$Native_Utils.update(
				_p160,
				{
					content: A2(_user$project$Grid$sectionContentSetName, name, _p160.content)
				}));
	});
var _user$project$Grid$nameSection = F3(
	function (name, section, model) {
		return A2(
			_user$project$Grid$updateSection,
			A2(_user$project$Grid$sectionSetName, name, section),
			model);
	});
var _user$project$Grid$sectionContentClearName = function (_p161) {
	var _p162 = _p161;
	return _user$project$Grid$SectionContent(
		_elm_lang$core$Native_Utils.update(
			_p162._0,
...
var _user$project$Grid$sectionClearName = function (_p163) {
	var _p164 = _p163;
	var _p165 = _p164._0;
	return _user$project$Grid$Section(
		_elm_lang$core$Native_Utils.update(
			_p165,
			{
				content: _user$project$Grid$sectionContentClearName(_p165.content)
			}));
};
var _user$project$Grid$unnameSection = F2(
	function (section, model) {
		return A2(
			_user$project$Grid$updateSection,
			_user$project$Grid$sectionClearName(section),
			model);
	});
var _user$project$Grid$Placeholder = function (a) {
	return {ctor: 'Placeholder', _0: a};
};
var _user$project$Grid$PlaceholderElement = function (a) {
	return {ctor: 'PlaceholderElement', _0: a};
};
var _user$project$Grid$placeholderElementAt = function (_p166) {
	var _p167 = _p166;
	return _user$project$Grid$PlaceholderElement(
		_user$project$Grid$Placeholder(
			{row: _p167._0, col: _p167._1}));
};
var _user$project$Grid$SectionElement = function (a) {
	return {ctor: 'SectionElement', _0: a};
};
var _user$project$Grid$sectionElement = function (section) {
	return _user$project$Grid$SectionElement(section);
};
var _user$project$Grid$gridCSS = F2(
	function (selector, _p168) {
		var _p169 = _p168;
		var sectionClass = F2(
			function (i, s) {
				return A2(
					...
					A2(
						_elm_lang$core$Maybe$map,
						_user$project$Grid$slugify,
						_user$project$Grid$sectionName(s)));
			});
		var toCSS = F2(
			function (i, s) {
				return A2(
					_user$project$Grid$sectionElementToCSS,
					A2(
						_elm_lang$core$Basics_ops['++'],
						'#',
						A2(sectionClass, i, s)),
					_user$project$Grid$sectionElement(s));
			});
		var sectionCSS = A2(
			_elm_lang$core$List$indexedMap,
			toCSS,
			_elm_lang$core$List$reverse(_p169._0.sections));
		return A2(
			_elm_lang$core$String$join,
			'\n\n',
			{
				ctor: '::',
				_0: A2(_user$project$Grid$gridToCSS, selector, _p169._0.grid),
				_1: sectionCSS
			});
	});
var _user$project$Grid$gridSectionElements = F2(
	function (grid, sections) {
		var accum = F2(
			function (_p170, elements) {
				var _p171 = _p170;
				var _p174 = _p171._0;
				var _p173 = _p171._1;
				var r = {top: _p174, left: _p173, bottom: _p174, right: _p173};
				return function (el) {
					return {ctor: '::', _0: el, _1: elements};
				}(
					A2(
						_elm_lang$core$Maybe$withDefault,
						_user$project$Grid$placeholderElementAt(
							{ctor: '_Tuple2', _0: _p174, _1: _p173}),
						A2(
							_elm_lang$core$Maybe$map,
							_user$project$Grid$sectionElement,
							A2(
								_user$project$Grid$listFind,
								function (_p172) {
									return A2(
										_user$project$Grid$rectInside,
										r,
										_user$project$Grid$sectionRect(_p172));
								},
								sections))));
			});
		return A3(
			...
			accum,
			{ctor: '[]'},
			_user$project$Grid$gridCoords(grid));
	});
var _user$project$Grid$sectionElements = function (_p175) {
	var _p176 = _p175;
	return A2(_user$project$Grid$gridSectionElements, _p176._0.grid, _p176._0.sections);
};
var _user$project$Grid$Rightward = {ctor: 'Rightward'};
var _user$project$Grid$expandSectionRightward = _user$project$Grid$expandSection(_user$project$Grid$Rightward);
var _user$project$Grid$Downward = {ctor: 'Downward'};
var _user$project$Grid$expandSectionDownward = _user$project$Grid$expandSection(_user$project$Grid$Downward);
var _user$project$Grid$Leftward = {ctor: 'Leftward'};
var _user$project$Grid$shiftRemoveFirstCol = function (_p177) {
	var _p178 = _p177;
	var _p179 = _p178._0;
	var shiftLeftIfPossible = function (section) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			section,
			A3(_user$project$Grid$sectionShift, _user$project$Grid$Leftward, _p179.grid, section));
	};
	return _user$project$Grid$Model(
		_elm_lang$core$Native_Utils.update(
			_p179,
			{
				grid: _user$project$Grid$removeFirstGridCol(_p179.grid),
				sections: A2(_elm_lang$core$List$map, shiftLeftIfPossible, _p179.sections)
			}));
};
var _user$project$Grid$expandSectionLeftward = _user$project$Grid$expandSection(_user$project$Grid$Leftward);
var _user$project$Grid$Upward = {ctor: 'Upward'};
var _user$project$Grid$shiftRemoveFirstRow = function (_p180) {
	var _p181 = _p180;
	var _p182 = _p181._0;
	var shiftUpIfPossible = function (section) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			section,
			A3(_user$project$Grid$sectionShift, _user$project$Grid$Upward, _p182.grid, section));
	};
	return _user$project$Grid$Model(
		_elm_lang$core$Native_Utils.update(
			_p182,
			{
				grid: _user$project$Grid$removeFirstGridRow(_p182.grid),
				sections: A2(_elm_lang$core$List$map, shiftUpIfPossible, _p182.sections)
			}));
};
var _user$project$Grid$expandSectionUpward = _user$project$Grid$expandSection(_user$project$Grid$Upward);
var _user$project$Grid$sectionCanExpand = F3(
	function (grid, section, sections) {
		var sections_ = A2(_user$project$Grid$sectionRemoveFrom, section, sections);
		var canPlace = function (s) {
			return A3(_user$project$Grid$sectionCanBePlacedIn, grid, s, sections_);
		};
		var maybeCanPlace = function (_p183) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				false,
				A2(_elm_lang$core$Maybe$map, canPlace, _p183));
		};
		return {
			upward: maybeCanPlace(
				A3(_user$project$Grid$sectionExpand, _user$project$Grid$Upward, grid, section)),
			leftward: maybeCanPlace(
				A3(_user$project$Grid$sectionExpand, _user$project$Grid$Leftward, grid, section)),
			downward: maybeCanPlace(
				A3(_user$project$Grid$sectionExpand, _user$project$Grid$Downward, grid, section)),
			rightward: maybeCanPlace(
				A3(_user$project$Grid$sectionExpand, _user$project$Grid$Rightward, grid, section))
		};
	});
var _user$project$Grid$canExpandSection = F2(
	function (section, _p184) {
		var _p185 = _p184;
		return A3(_user$project$Grid$sectionCanExpand, _p185._0.grid, section, _p185._0.sections);
	});
var _user$project$Grid$MinContent = {ctor: 'MinContent'};
var _user$project$Grid$minContent = _user$project$Grid$MinContent;
var _user$project$Grid$Fr = function (a) {
	return {ctor: 'Fr', _0: a};
};
var _user$project$Grid$fr = function (i) {
	return _user$project$Grid$Fr(i);
};
var _user$project$Grid$StdUnit = function (a) {
	return {ctor: 'StdUnit', _0: a};
};
var _user$project$Grid$gridUnit = function (u) {
	return _user$project$Grid$StdUnit(u);
};
var _user$project$Grid$Rem = function (a) {
	return {ctor: 'Rem', _0: a};
};
var _user$project$Grid$rem = function (i) {
	return _user$project$Grid$Rem(i);
};
var _user$project$Grid$Px = function (a) {
	return {ctor: 'Px', _0: a};
};
var _user$project$Grid$emptyGrid = _user$project$Grid$Grid(
	{
		rows: {ctor: '[]'},
		cols: {ctor: '[]'},
		rowGap: _user$project$Grid$Px(0),
		colGap: _user$project$Grid$Px(0)
	});
var _user$project$Grid$empty = _user$project$Grid$Model(
	{
		grid: _user$project$Grid$emptyGrid,
		sections: {ctor: '[]'}
	});
var _user$project$Grid$px = function (i) {
	return _user$project$Grid$Px(i);
};
var _user$project$Grid$standardUnitSetValue = F2(
	function (value, unit) {
		var _p186 = unit;
		if (_p186.ctor === 'Px') {
			return _user$project$Grid$Px(value);
		} else {
			return _user$project$Grid$Rem(value);
		}
	});
var _user$project$Grid$gridUnitSetValue = F2(
	function (value, unit) {
		var _p187 = unit;
		switch (_p187.ctor) {
			case 'StdUnit':
				return _user$project$Grid$StdUnit(
					A2(_user$project$Grid$standardUnitSetValue, value, _p187._0));
			case 'Fr':
				return _user$project$Grid$Fr(value);
			default:
				return _user$project$Grid$MinContent;
		}
	});
...
var _user$project$Main$viewUnit = F3(
	function (tagger, index, unit) {
		var parseUnit = function (sunit) {
			var defaultUnitValue = function (_p0) {
				return A2(
					_elm_lang$core$Maybe$withDefault,
					1.0,
					A2(
						...
						_user$project$Grid$gridUnitRange(_p0)));
			};
			var _p1 = sunit;
			switch (_p1) {
				case 'px':
					return _user$project$Grid$gridUnit(
						_user$project$Grid$px(
							defaultUnitValue(
								_user$project$Grid$gridUnit(
									_user$project$Grid$px(1)))));
				case 'rem':
					return _user$project$Grid$gridUnit(
						_user$project$Grid$rem(
							defaultUnitValue(
								_user$project$Grid$gridUnit(
									_user$project$Grid$rem(1)))));
				case 'fr':
					return _user$project$Grid$fr(
						defaultUnitValue(
							_user$project$Grid$fr(1)));
				case 'min-content':
					return _user$project$Grid$minContent;
				default:
					return _user$project$Grid$fr(1);
			}
		};
		var unitControl = A2(
			...
			{
				ctor: '::',
				_0: _user$project$Main$onChange(
					function (_p2) {
						return A2(
							tagger,
							index,
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$value('px'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$selected(
								_user$project$Grid$gridUnitIsPx(unit)),
							_1: {ctor: '[]'}
						}
					},
					{
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$value('rem'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$selected(
									_user$project$Grid$gridUnitIsRem(unit)),
								_1: {ctor: '[]'}
							}
						},
						{
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value('fr'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$selected(
										_user$project$Grid$gridUnitIsFr(unit)),
									_1: {ctor: '[]'}
								}
							},
							{
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$value('min-content'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$selected(
											_user$project$Grid$gridUnitIsMinContent(unit)),
										_1: {ctor: '[]'}
									}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('min-content'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
		...
		var parseUnitValue = function (s) {
			return A2(
				...
				A2(
					...
					function (n) {
						return A2(_user$project$Grid$gridUnitSetValue, n, unit);
					},
						...
						_1: {
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Attributes$min(
									_elm_lang$core$Basics$toString(_p4.min)),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$max(
										_elm_lang$core$Basics$toString(_p4.max)),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$step(
											_elm_lang$core$Basics$toString(_p4.step)),
										_1: {
											ctor: '::',
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('grid-unit-value'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							_elm_lang$html$Html$text(
								_user$project$Grid$gridUnitToString(unit)),
							A3(
								_elm_lang$core$Maybe$map2,
								rangeControl,
								_user$project$Grid$gridUnitValue(unit),
								_user$project$Grid$gridUnitRange(unit))),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('test-test'),
							_1: {ctor: '[]'}
						},
						{ctor: '[]'}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('grid-unit-unit'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _user$project$Main$viewCSS = function (model) {
	var noheaders = _user$project$Grid$shiftRemoveFirstCol(
		_user$project$Grid$shiftRemoveFirstRow(model));
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(_user$project$Grid$gridCSS, '#grid', noheaders)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
...
var _user$project$Main$defaultColUnit = _user$project$Grid$fr(1);
var _user$project$Main$defaultRowUnit = _user$project$Grid$gridUnit(
	_user$project$Grid$px(100));
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p6 = msg;
		switch (_p6.ctor) {
			case 'AddRow':
				return A3(_user$project$Grid$addRow, _p6._0, _user$project$Main$defaultColUnit, model);
			case 'AddCol':
				return A3(_user$project$Grid$addCol, _p6._0, _user$project$Main$defaultRowUnit, model);
			case 'RemoveRow':
				return _user$project$Grid$removeRow(model);
			case 'RemoveCol':
				return _user$project$Grid$removeCol(model);
			case 'SetRowHeight':
				return A3(_user$project$Grid$setRowHeight, _p6._0, _p6._1, model);
			case 'SetColWidth':
				return A3(_user$project$Grid$setColWidth, _p6._0, _p6._1, model);
			case 'AddSection':
				return A2(_user$project$Grid$addSection, _p6._0, model);
			case 'RemoveSection':
				return A2(_user$project$Grid$removeSection, _p6._0, model);
			case 'ExpandUpward':
				return A2(_user$project$Grid$expandSectionUpward, _p6._0, model);
			case 'ExpandLeftward':
				return A2(_user$project$Grid$expandSectionLeftward, _p6._0, model);
			case 'ExpandDownward':
				return A2(_user$project$Grid$expandSectionDownward, _p6._0, model);
			case 'ExpandRightward':
				return A2(_user$project$Grid$expandSectionRightward, _p6._0, model);
			default:
				var _p8 = _p6._0;
				var _p7 = _p6._1;
				if (_p7.ctor === 'Just') {
					return A3(_user$project$Grid$nameSection, _p7._0, _p8, model);
				} else {
					return A2(_user$project$Grid$unnameSection, _p8, model);
				}
		}
	});
var _user$project$Main$init = A3(
	_user$project$Grid$addRow,
	_user$project$Grid$minContent,
	_user$project$Grid$minContent,
	A2(
		_user$project$Grid$mapGrid,
		_user$project$Grid$setGap(
			_user$project$Grid$px(10)),
		_user$project$Grid$empty));
var _user$project$Main$NameSection = F2(
	function (a, b) {
		return {ctor: 'NameSection', _0: a, _1: b};
	});
var _user$project$Main$viewSectionBody = function (section) {
	var currentValue = _user$project$Grid$sectionName(section);
	var parseInput = function (s) {
		return _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$String$length(s),
			0) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(s);
	};
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('grid-section-body'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('grid-section-name'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
						...
						_elm_lang$html$Html$input,
						{
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Events$onInput(
									function (_p9) {
										return A2(
											_user$project$Main$NameSection,
											section,
											parseInput(_p9));
									}),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder('Name this section'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(
											A2(_elm_lang$core$Maybe$withDefault, '', currentValue)),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$Main$ExpandRightward = function (a) {
	return {ctor: 'ExpandRightward', _0: a};
};
var _user$project$Main$ExpandDownward = function (a) {
	return {ctor: 'ExpandDownward', _0: a};
};
var _user$project$Main$ExpandLeftward = function (a) {
	return {ctor: 'ExpandLeftward', _0: a};
};
var _user$project$Main$ExpandUpward = function (a) {
	return {ctor: 'ExpandUpward', _0: a};
};
var _user$project$Main$RemoveSection = function (a) {
	return {ctor: 'RemoveSection', _0: a};
};
var _user$project$Main$viewSectionControls = F2(
	function (model, section) {
		var expandButton = F2(
			function (msg, symb) {
				return A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(symb),
						_1: {ctor: '[]'}
					});
			});
		var exceptIfSecondRowOrCol = function (exp) {
			return _elm_lang$core$Native_Utils.update(
				exp,
				{
					upward: exp.upward && (!A2(_user$project$Grid$sectionInRow, 1, section)),
					leftward: exp.leftward && (!A2(_user$project$Grid$sectionInCol, 1, section))
				});
		};
		var canExpand = exceptIfSecondRowOrCol(
			A2(_user$project$Grid$canExpandSection, section, model));
		var spanControls = function () {
			var exp = canExpand;
			return A2(
				_elm_lang$core$Basics_ops['++'],
				exp.upward ? {
					...
					_0: A2(
						expandButton,
						_user$project$Main$ExpandUpward(section),
						'⇡'),
					_1: {ctor: '[]'}
				} : {ctor: '[]'},
				A2(
					...
					exp.leftward ? {
						...
						_0: A2(
							expandButton,
							_user$project$Main$ExpandLeftward(section),
							'⇠'),
						_1: {ctor: '[]'}
					} : {ctor: '[]'},
					A2(
						...
						exp.downward ? {
							...
							_0: A2(
								expandButton,
								_user$project$Main$ExpandDownward(section),
								'⇣'),
							_1: {ctor: '[]'}
						} : {ctor: '[]'},
						exp.rightward ? {
							...
							_0: A2(
								expandButton,
								_user$project$Main$ExpandRightward(section),
								'⇢'),
							_1: {ctor: '[]'}
						} : {ctor: '[]'})));
		}();
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('grid-section-controls'),
				_1: {ctor: '[]'}
			},
			A2(
				_elm_lang$core$Basics_ops['++'],
					...
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Main$RemoveSection(section)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Main$AddSection = function (a) {
	return {ctor: 'AddSection', _0: a};
};
var _user$project$Main$SetColWidth = F2(
	function (a, b) {
		return {ctor: 'SetColWidth', _0: a, _1: b};
	});
var _user$project$Main$viewColHeader = F2(
	function (model, placeholder) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_elm_lang$html$Html$text(''),
			function (i) {
				return A2(
					_elm_lang$core$Maybe$map,
					function (u) {
						return A3(_user$project$Main$viewUnit, _user$project$Main$SetColWidth, i, u);
					},
					A2(_user$project$Grid$colUnit, i, model));
			}(
				_user$project$Grid$placeholderCol(placeholder)));
	});
var _user$project$Main$SetRowHeight = F2(
	function (a, b) {
		return {ctor: 'SetRowHeight', _0: a, _1: b};
	});
var _user$project$Main$viewRowHeader = F2(
	function (model, placeholder) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			_elm_lang$html$Html$text(''),
			function (i) {
				return A2(
					_elm_lang$core$Maybe$map,
					function (u) {
						return A3(_user$project$Main$viewUnit, _user$project$Main$SetRowHeight, i, u);
					},
					A2(_user$project$Grid$rowUnit, i, model));
			}(
				_user$project$Grid$placeholderRow(placeholder)));
	});
var _user$project$Main$viewSectionEl = F2(
	function (model, el) {
		var _p10 = function () {
			var _p11 = el;
			if (_p11.ctor === 'PlaceholderElement') {
				var _p13 = _p11._0;
				var _p12 = {
					ctor: '_Tuple2',
					_0: A2(_user$project$Grid$placeholderInRow, 0, _p13),
					_1: A2(_user$project$Grid$placeholderInCol, 0, _p13)
				};
				if (_p12._0 === true) {
					if (_p12._1 === true) {
						return {
							...
							_0: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('grid-section-corner'),
								_1: {ctor: '[]'}
							},
							_1: {ctor: '[]'}
						};
						...
						return {
							...
							_0: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('grid-section-colheader'),
								_1: {ctor: '[]'}
							},
							_1: {
								ctor: '::',
								_0: A2(_user$project$Main$viewColHeader, model, _p13),
								_1: {ctor: '[]'}
							}
						};
					}
					...
					if (_p12._1 === true) {
						return {
							...
							_0: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('grid-section-rowheader'),
								_1: {ctor: '[]'}
							},
							_1: {
								ctor: '::',
								_0: A2(_user$project$Main$viewRowHeader, model, _p13),
								_1: {ctor: '[]'}
							}
						};
					} else {
						return {
							...
							_0: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('grid-section-placeholder'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_user$project$Main$AddSection(_p13)),
									_1: {ctor: '[]'}
								}
							},
							_1: {ctor: '[]'}
				...
				return {
					...
					_1: {
						ctor: '::',
						_0: A2(_user$project$Main$viewSectionControls, model, _p14),
						_1: {
							ctor: '::',
							_0: _user$project$Main$viewSectionBody(_p14),
							_1: {ctor: '[]'}
						}
					}
				};
		...
		var commonAttrs = {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('grid-section'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(
					_user$project$Grid$gridSectionStyles(el)),
				_1: {ctor: '[]'}
			}
		};
		return A2(
			_elm_lang$html$Html$div,
			A2(_elm_lang$core$Basics_ops['++'], commonAttrs, attrs),
			body);
	});
var _user$project$Main$viewGrid = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(
				_user$project$Grid$gridStyles(model)),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$List$map,
			_user$project$Main$viewSectionEl(model),
			_user$project$Grid$sectionElements(model)));
};
var _user$project$Main$RemoveCol = {ctor: 'RemoveCol'};
var _user$project$Main$RemoveRow = {ctor: 'RemoveRow'};
var _user$project$Main$AddCol = function (a) {
	return {ctor: 'AddCol', _0: a};
};
var _user$project$Main$viewColControls = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		...
		_1: {
			...
			_0: A2(
				_elm_lang$html$Html$button,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Main$AddCol(_user$project$Main$defaultColUnit)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$RemoveCol),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Main$AddRow = function (a) {
	return {ctor: 'AddRow', _0: a};
};
var _user$project$Main$viewRowControls = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		...
		_1: {
			...
			_0: A2(
				_elm_lang$html$Html$button,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Main$AddRow(_user$project$Main$defaultRowUnit)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_user$project$Main$RemoveRow),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('grid-controls'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _user$project$Main$viewRowControls,
					_1: {
						ctor: '::',
						_0: _user$project$Main$viewColControls,
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$Main$viewGrid(model),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('grid-css'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(_elm_lang$html$Html_Lazy$lazy, _user$project$Main$viewCSS, model),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Main$main = _elm_lang$html$Html$beginnerProgram(
	{view: _user$project$Main$view, update: _user$project$Main$update, model: _user$project$Main$init})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Grid.StandardUnit":{"args":[],"tags":{"Rem":["Float"],"Px":["Float"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Main.Msg":{"args":[],"tags":{"ExpandDownward":["Grid.Section"],"RemoveRow":[],"SetColWidth":["Int","Grid.GridUnit"],"RemoveSection":["Grid.Section"],"ExpandLeftward":["Grid.Section"],"AddSection":["Grid.Placeholder"],"ExpandUpward":["Grid.Section"],"AddRow":["Grid.GridUnit"],"NameSection":["Grid.Section","Maybe.Maybe String"],"ExpandRightward":["Grid.Section"],"AddCol":["Grid.GridUnit"],"SetRowHeight":["Int","Grid.GridUnit"],"RemoveCol":[]}},"Grid.Section":{"args":[],"tags":{"Section":["{ row : Int , col : Int , rowSpan : Int , colSpan : Int , content : Grid.SectionContent }"]}},"Grid.Placeholder":{"args":[],"tags":{"Placeholder":["{ row : Int, col : Int }"]}},"Grid.GridUnit":{"args":[],"tags":{"Fr":["Float"],"StdUnit":["Grid.StandardUnit"],"MinContent":[]}},"Grid.SectionContent":{"args":[],"tags":{"SectionContent":["{ name : Maybe.Maybe String }"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
